...
const AddFaceColorPage = () => {
  ...
  const onSubmit = async (formValues: InputType) => {
    ...
    axios
      .post("/api/categories/faceColors", formValues)
      .then(() => {
        toast.success("文字盤の色を追加しました");
  ...
  return (
    <section className="mt-8 text-foreground">
      <h1 className="text-2xl font-bold">文字盤の色を追加する</h1>
      <form
...
export default AddFaceColorPage;
