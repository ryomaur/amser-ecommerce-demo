...
export const metadata = {
  title: "サポート | Amser",
  description: "カスタマーサポートページ",
};

const SupportPage = () => {
  return (
    <div className="main-container my-20 min-h-[50vh] font-sans text-foreground">
      <div className="py-8 md:py-16">
        <h1 className="text-center text-3xl font-bold">サポート</h1>
      </div>

      <div className="mt-3 w-full rounded-2xl bg-transparent pb-20 md:mt-10">
        <div className="px-8 md:px-20">
          <div id="shipping">
            <div className="flex items-center gap-8">
              <MdOutlineLocalShipping size={32} />
              <h2 className="text-xl font-bold md:text-2xl">発送</h2>
            </div>
          ...
          <div id="payment" className="pt-20">
            <div className="flex items-center gap-8">
              <MdOutlinePayment size={32} />
              <h2 className="text-xl font-bold md:text-2xl">お支払い</h2>
            </div>
            <div className="pt-5 text-sm md:text-base">
              <p>
                吾輩は猫である。名前はまだ無い。どこで生れたかとんと見当がつかぬ。何でも薄暗いじめじめした所でニャーニャー泣いていた事だけは記憶している。吾輩はここで始めて人間というものを見た。しかもあとで聞くとそれは書生という人間中で一番獰悪な種族であったそうだ。この書生というのは時々我々を捕えて煮て食うという話である。しかしその当時は何という考もなかったから別段恐しいとも思わなかった。ただ彼の掌に載せられてスーと持ち上げられた時何だかフワフワした感じがあったばかりである。
          ...
          <div id="maintenance" className="pt-20">
            <div className="flex items-center gap-8">
              <MdOutlineHomeRepairService size={32} />
              <h2 className="text-xl font-bold md:text-2xl">メンテナンス</h2>
            </div>
            <div className="pt-5 text-sm md:text-base">
              <p>
                吾輩は猫である。名前はまだ無い。どこで生れたかとんと見当がつかぬ。何でも薄暗いじめじめした所でニャーニャー泣いていた事だけは記憶している。吾輩はここで始めて人間というものを見た。しかもあとで聞くとそれは書生という人間中で一番獰悪な種族であったそうだ。この書生というのは時々我々を捕えて煮て食うという話である。しかしその当時は何という考もなかったから別段恐しいとも思わなかった。ただ彼の掌に載せられてスーと持ち上げられた時何だかフワフワした感じがあったばかりである。
          ...
          <div id="repair" className="pt-20">
            <div className="flex items-center gap-8">
              <TiSpanner size={32} />
              <h2 className="text-xl font-bold md:text-2xl">修理</h2>
            </div>
            <div className="pt-5 text-sm md:text-base">
              <p>
                吾輩は猫である。名前はまだ無い。どこで生れたかとんと見当がつかぬ。何でも薄暗いじめじめした所でニャーニャー泣いていた事だけは記憶している。吾輩はここで始めて人間というものを見た。しかもあとで聞くとそれは書生という人間中で一番獰悪な種族であったそうだ。この書生というのは時々我々を捕えて煮て食うという話である。しかしその当時は何という考もなかったから別段恐しいとも思わなかった。ただ彼の掌に載せられてスーと持ち上げられた時何だかフワフワした感じがあったばかりである。
